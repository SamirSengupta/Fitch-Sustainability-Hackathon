...
>
> **Challenge**: Enhanced Emissions Estimates for ESG Data Completeness
>
> **Team**: SamCodeMan

🔗 [View Live Demo](https://fitch-sustainability-hackathon.onrender.com/)
...
### 1. Data Ingestion
Analyzed **5,000+ records** from the `Manufacturing_ESG_Financial_Data.csv`.
...
### 3. Modeling
- Utilized **Random Forest Regression** (`n_estimators=100`) to capture non-linear relationships between firm size and environmental impact.

### 4. Pipeline
- Implemented a **Scikit-Learn Pipeline** to handle preprocessing and inference seamlessly in production.
...
```bash
git clone https://github.com/SamirSengupta/Fitch-Sustainability-Hackathon.git
